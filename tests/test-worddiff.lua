-- test-worddiff.lua: cache.lua's M.word_diff, the pairing + token-diff
...
--
-- Usage: luajit test-worddiff.lua <cache.lua path>
--
...
assert(arg[1], "usage: luajit test-worddiff.lua <cache.lua path>")
